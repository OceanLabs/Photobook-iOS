...
extension AssetPickerCollectionViewController {
    ...
    static func instagramAssetPicker() -> AssetPickerCollectionViewController{
        let assetPicker = PhotobookUtils.photobookStoryBoard(name: "Main").instantiateViewController(withIdentifier: "AssetPickerCollectionViewController") as! AssetPickerCollectionViewController
