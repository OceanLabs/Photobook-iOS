...
class PhotobookViewController: UIViewController, PhotobookNavigationBarDelegate {
    ...
    @IBAction func didTapCheckout(_ sender: Any) {
        ...
        let goToCheckout = {
            let orderSummaryViewController = PhotobookUtils.photobookStoryBoard(name: "Main").instantiateViewController(withIdentifier: "OrderSummaryViewController") as! OrderSummaryViewController
    ...
    private func editPage(at index: Int, frame: CGRect, containerView: UIView) {
        let modalNavigationController = PhotobookUtils.photobookStoryBoard(name: "Main").instantiateViewController(withIdentifier: "PageSetupNavigationController") as! UINavigationController
        if #available(iOS 11.0, *) {
...
extension PhotobookViewController: PhotobookCoverCollectionViewCellDelegate {
    ...
    func didTapOnSpine(with rect: CGRect, in containerView: UIView) {
        ...
        let spineTextEditingNavigationController = PhotobookUtils.photobookStoryBoard(name: "Main").instantiateViewController(withIdentifier: "SpineTextEditingNavigationController") as! UINavigationController
