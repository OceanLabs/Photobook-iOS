...
class CheckoutViewController: UIViewController {
    ...
    private func updateViews() {
        ...
        //product
        itemTitleLabel.text = OrderManager.shared.basketOrder.items.first!.template.name
        itemPriceLabel.text = OrderManager.shared.basketOrder.cachedCost?.lineItems?.first?.formattedCost
        itemAmountButton.setTitle("\(OrderManager.shared.basketOrder.items.first!.itemCount)", for: .normal)
        updateItemImage()
    ...
    @IBAction private func presentAmountPicker() {
        ...
        amountPickerViewController.selectedValue = OrderManager.shared.basketOrder.items.first!.itemCount
...
extension CheckoutViewController: AmountPickerDelegate {
    func amountPickerDidSelectValue(_ value: Int) {
        OrderManager.shared.basketOrder.items.first!.itemCount = value
