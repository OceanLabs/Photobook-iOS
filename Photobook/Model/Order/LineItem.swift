...
class LineItem: Codable {
    ...
    static func parseDetails(dictionary: [String: Any], localeCurrencyCode: String? = Locale.current.currencyCode) -> LineItem? {
        guard
            ...
            let cost = Price.parse(costDictionary, localeCurrencyCode: localeCurrencyCode)
            else { return nil }
