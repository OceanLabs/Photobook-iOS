...
enum ReceiptViewControllerState: Int {
    ...
    private struct Constants {
        ...
        static let infoDescriptionCompleted = NSLocalizedString("ReceiptViewControllerState/InfoDescriptionCompleted", value: "We have received your photos and we will begin processing your order shortly", comment: "Info text when order has been completed")
